...
export const CAPTURE_PERMISSION_HINT =
  "Chrome needs one click first. Click the Notetaker icon in the Chrome toolbar while this tab is open, then press Start.";
...
export const MIC_PERMISSION_HINT =
  "Notetaker needs microphone access. Allow it once and your notes will start right away.";
