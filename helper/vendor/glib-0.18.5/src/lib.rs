...
// This pinned 0.18 API is intentionally kept source-compatible with the
// stable Tauri 2 GTK stack; these are pre-existing compiler lints in the
// upstream release, unrelated to the security backport below.
#![allow(unused_parens)]
